...
"""
openedx-owly-apis documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-owly-apis',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/aulasneo/openedx-owly-apis",
...
#
# html_title = 'openedx-owly-apis v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_owly_apis'),
                os.path.join(root_path, 'openedx_owly_apis/migrations')])
